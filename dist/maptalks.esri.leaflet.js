...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('maptalks'), require('leaflet'), require('esri-leaflet')) :
	typeof define === 'function' && define.amd ? define(['exports', 'maptalks', 'leaflet', 'esri-leaflet'], factory) :
	(factory((global.maptalks = global.maptalks || {}),global.maptalks,global.L,global.esriLeaflet));
}(this, (function (exports,maptalks,L,esriLeaflet) { 'use strict';
...
LeafletLayer.registerRenderer('dom', function () {
    ...
    _class.prototype._createLayerContainer = function _createLayerContainer() {
        var container = this._container = maptalks.DomUtil.createEl('div', 'maptalks-leaflet');
